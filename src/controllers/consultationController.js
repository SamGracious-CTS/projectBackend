...
exports.getAppointmentsByDoctor = async (req, res) => {
  try {
    const registrationNumber = req.params.registrationNumber || req.query.registrationNumber;
...
exports.createConsultation = async (req, res) => {
  try {
    ...
    if (!registrationNumber || !patientId || !appointmentId) {
      return res.status(400).json({ message: "registrationNumber, patientId and appointmentId are required in request body" });
    }
